        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-serif font-bold text-xl text-foreground tracking-tight">Ulavar Santhai</span>
            </Link>
      ...
      <footer className="border-t border-border bg-card mt-auto">
        <div className="container mx-auto px-4 py-12 text-center md:text-left">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <Link href="/" className="flex items-center gap-2 justify-center md:justify-start mb-4">
                ...
                <span className="font-serif font-bold text-xl text-foreground">Ulavar Santhai</span>
              </Link>
          ...
          <div className="border-t border-border mt-12 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} Ulavar Santhai. Built with care.</p>
          </div>
        </div>
      </footer>
    </div>
